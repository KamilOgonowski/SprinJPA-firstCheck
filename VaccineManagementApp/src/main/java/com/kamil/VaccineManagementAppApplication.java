...
//		List<Serializable> listka2 = Arrays.asList(9);
//		System.out.println(service.deleteVaccinesByIdsTransactional(listka2));
		
		
		VaccineDetails vaccineToBeDeleted = new VaccineDetails("AstraZeneca","No Pain no Gain", 45478 );
		vaccineToBeDeleted.setId(1L); // I have not created a constructor to insert ID which is actually generated by the DB engine, so I set it using set method
		System.out.println(service.deleteVaccinesByObject(vaccineToBeDeleted));
